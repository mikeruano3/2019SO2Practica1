        ...
        $.ajax({
            ...
            success : function(data){
                if(data.tipo == "NORMAL"){
                    var i, html, iteml;
                    html = "";
                    document.getElementById("usadoPorc").innerHTML = "Porcentaje: " + data.usadoPorc + "%";
                    document.getElementById("usadoKB").innerHTML = "Usado: "+ data.usadoKB + " KB";
                    cola.push(data.usadoPorc);
                }
                //alert(data.tipo);
            },
